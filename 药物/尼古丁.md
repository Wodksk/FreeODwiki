...
<details>
    <summary> b站网友的锐评，一语道破天机！</summary>
...
|                                                               |                                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Yellow-warning-sign1.png](../文件/Yellow-warning-sign1.png) | 尼古丁在口腔和胃中可反应形成 N-亚硝基降烟碱 (NNN)，[^1] 这是一种已知的 <mark>**1 型致癌物**</mark>，[^2] 表明即使是非烟草形式的尼古丁摄入也可能在致癌过程中发挥作用。[^3] 即使是口服尼古丁替代疗法产品理论上也可能增加癌症风险。<br>**为了安全**：按照说明使用尼古丁贴片不会带来这种风险，因为 NNN 形成不会通过皮肤吸收发生。 |
...
**尼古丁** 是一种天然存在的生物碱，由于它能同时影响多种生物系统，因此既有兴奋作用也有抑制作用。[^4]

尼古丁属于吡啶和吡咯烷类物质。它是夜影科植物中最主要的生物碱，[^5] 通过与烟碱型乙酰胆碱受体（nAChRs）结合来发挥作用。[^6]

作为尼古丁电子烟和烟草（香烟、雪茄、鼻烟、鼻烟袋）中的主要精神活性成分，尼古丁是世界上使用最广泛的物质之一。[^7] 它也被用作抗食草剂来阻止植物被捕食，过去还曾用作杀虫剂。[^8]
...
| ![](<../文件/Size_of_nicotine_pouch_(cropped).png>) |
| --------------------------------------------------- |
| 单个 3cm 尼古丁袋                                   |
...
| ![](../文件/960px-Nicotine_pastille.jpg) |
| ---------------------------------------- |
| 尼古丁含片                               |
...
[加热烟草产品](https://en.wikipedia.org/wiki/Heated_tobacco_product) (HTP) 是一种[烟草](烟草.md)产品，以低于传统香烟的温度加热烟草。这些产品含有尼古丁，这是一种高度成瘾的化学物质。热量产生气溶胶或烟雾供吸入，其中含有尼古丁和其他化学物质。HTP 也可能含有烟草中没有的添加剂，包括调味化学物质。HTP 通常将烟草加热到 600 °C (1100 °F) 以下的温度，低于传统香烟。
